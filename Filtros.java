...
public class Filtros {
    ...
    private static void procesar(int ancho, int alto, BufferedImage img, double[][] m, int[][] mr, int[][] mg, int[][] mb, BufferedImage img2, double[][] m2, int[][] mr2, int[][] mg2, int[][] mb2) {
        ...
        marco2.getContentPane().add(new JLabel("<html>  Tecla ----> Filtro<br>"
                                    +" Tecla G ----> Grises<br>"
                                    +" Tecla N ----> Negativo<br>"
                                    +" Tecla C ----> Contraste (+) (-)<br>"
                                    +" Tecla D ----> Desenfoque<br>"
                                    +" Tecla M ----> Mediana<br>"
                                    +" Tecla B ----> Bordes<br>"
                                    +" Tecla S ----> Sumar<br>"
                                    +" Tecla R ----> Restar<br>"
                                    +" Tecla 2 ----> Binarizacion Simple<br>"
                                    +" Tecla 3 ----> Binarizacion Compuesta<br>"
                                    +" Tecla 4 ----> Segmentacion</html>"));
        marco2.setSize(450, 250);
        marco2.setLocation(500, 0);

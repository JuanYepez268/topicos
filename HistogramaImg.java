...
public class HistogramaImg extends JPanel {

    private BufferedImage imagen;

    public HistogramaImg(BufferedImage imagen) {
        this.imagen = imagen;
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        for (int i = 0; i < 256; i++) {
            System.out.println(histogramaR[i]+" - "+ histogramaG[i] + " - "+ histogramaB[i]);
            if (histogramaR[i] == histogramaG[i] && histogramaG[i] == histogramaB[i]){
